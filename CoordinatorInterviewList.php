...
<?php
	...
	mysql_select_db("lbas_hr") 
		...
		$result = mysql_query("
				  ...
				  WHERE E_Status = 'Applicant' AND HR_Status = 'Pass' AND Teaching_Status = 'Pass' and Test_Status = 'Pass' AND applicant_schedule.ID_No LIKE person.ID_No AND Coordinator_Status != 'Pending'
				");
