      ...
      <div class="row">
        <div class="span6">
          ...
          <div class="widget">
            ...
            <div class="widget-content">
                    ...
                    <iframe src="https://im.chikka.com/#" height="400" width="500" scrolling="auto">Message</iframe>
        ...
        <div class="span6">
          <div class="widget">
            ...
            <!-- /widget-header -->
            <div class="widget-content">
              <div class="shortcuts"> <a href="AttendancePage.php" class="shortcut"><i class="shortcut-icon icon-table"></i><span
                                        class="shortcut-label">Attendance</span> </a><a href="ReportsPage.php" class="shortcut"><i class="shortcut-icon icon-signal"></i> <span class="shortcut-label">Summary of Reports</span> </a>
                                        <a href="EmployeesPage.php" class="shortcut"><i class="shortcut-icon icon-group"></i><span class="shortcut-label">Employees</span></a>

                                        <a href="signup.php" class="shortcut"><i class="shortcut-icon icon-user"></i><span class="shortcut-label">Add Applicant</span></a>
