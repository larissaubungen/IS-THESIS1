...
<h5>Name of Guidance Counselor: </h5>
        <input type="text" placeholder="Name of Guidance Counselor">
        <div class="well" align="center">
        <table border="1">
            <thead>
                <tr>
        ...
        <table>
            ...
            <tbody>
                  <tr>
                        <td> 1. Has a general program that respons to the needs of the students </td>
                  ...
                  <tr> <td> 5. Effectively coordinates/facilitates concerns of students, parents and teachers when needed </td>
