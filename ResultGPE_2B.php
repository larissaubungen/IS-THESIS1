   ...
   echo '<input type="text" placeholder="Designation" value="'. $row['E_Position1'] . "/" . $row['E_Position2'] . '" readonly> <br>';
        ...
        echo '<table>';
            ...
            echo '<tbody>';
                  ...
                  echo '<tr>';
                        echo'<td> 2. Compliance with policies and directive ageter these have been discussed </td>';
                        echo '<td> &nbsp &nbsp &nbsp' . $ques_2 . '</td>';
                  echo '</tr>';
                  
                  echo '<tr>';
                       echo '<td> 3. Judicious use of time; systemization of work; planning for tasks ahead </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_3 . '</td>';
                  echo '</tr>';
                  
                  echo '<tr>';
                       echo '<td> 4. Comes to class on time </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_4 . '</td>';
                  echo '</tr>';

                  echo '<tr>';
                       echo '<td> 5. Building an open, hamonious relationship w/ supervisors </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_5 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td>6. Maintenance of a pleasant disposition toward job and persons around </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_6 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 7. Handling of problems arising from the work and workplace </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_7 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 8. Resourcefulness and creativity in doing assigned tasks  </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_8 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 9. Flexibility in responding to variances in working conditions </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_9 . '</td>';
                  echo '</tr>';

                   echo '<tr>';
                       echo '<td> 10. Effort to live out the LBASS core values and serve as a role model for students </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_10 . '</td>';
                  echo '</tr>';
                  

                  echo '<tr>';
                       echo '<td>  11. Sensitivity, tact and prudence in dealing with students and parents </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_11 . '</td>';
                  echo '</tr>';

                  echo '<tr>';
                       echo '<td> 12. Enforcement/compliance with guidelines on energy-saving, cost-cutting; care for school properties</td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_12 . '</td>';
                  echo '</tr>';

                  echo '<tr>';
                       echo '<td>13. Enforcment/compliance with the garbage management & other pro-environment thrusts of school</td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_13 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 14.Practice of good grooming  </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_14 . '</td>';
                  echo '</tr>';

                  echo '<tr>';
                       echo '<td> 15.Compliance with guidelines on the wearing of uniform</td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_15 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 16. Voluntarism (offering to be of help whenever possible) </td>';
