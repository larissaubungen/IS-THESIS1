...
<?php
	...
	mysql_select_db("lbas_hr") 
		...
		$result = mysql_query("
				  ...
				  WHERE E_Status = 'Applicant' AND HR_Status = 'Done' AND Teaching_Status = 'Done' and Test_Status = 'Done' AND applicant_schedule.ID_No LIKE person.ID_No AND Coordinator_Status = 'TBD'
				");
