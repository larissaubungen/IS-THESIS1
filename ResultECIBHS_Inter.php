  ...
  mysql_select_db("lbas_hr") 
    ...
    $result = mysql_query("
            SELECT  AVG(Ques_1),
                ...
                AVG(Result),
                Count(Result)
            FROM eval_ecib_intermmediatehighschool
   ...
   echo '<input type="text" placeholder="Designation" value="'. $row['E_Position1'] . "/" . $row['E_Position2'] . '" readonly> <br>';
        ...
        echo '<table>';
            ...
            echo '<tbody>';
                  ...
                  echo'<tr>';
                        echo '<td> 1. Has poise and well groomed </td>';
                        echo '<td> &nbsp &nbsp &nbsp'. $ques_1 . '</td>';
                  echo '</tr>';
                  
                  echo '<tr>';
                        echo'<td> 2. Has mastery over what she/he teaches (x5) </td>';
                        echo '<td> &nbsp &nbsp &nbsp' . $ques_2 . '</td>';
                  echo '</tr>';
                  
                  echo '<tr>';
                       echo '<td> 3. Has a well modulated voice (not too loud nor too soft) </td>';
                  ...
                  echo '<tr>';
                       echo '<td> 5. Is energetic and inspired to teach (x5) </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_5 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td>6. Shows that she/he plans lessons carefull (x3) </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_6 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 7. Has mastery of the language (x3) </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_7 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 8. Motivates students to participate in discussions and activities  </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_8 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 9. Makes sure that the classroom is clean and orderly </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_9 . '</td>';
                  echo '</tr>';

                   echo '<tr>';
                       echo '<td> 10. Uses variety in teaching procedures (x5) </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_10 . '</td>';
                  echo '</tr>';
                  

                  echo '<tr>';
                       echo '<td>  11. Relates lesson to daily life, human values, current events, etc </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_11 . '</td>';
                  echo '</tr>';

                  echo '<tr>';
                       echo '<td> 12. Are needed for learning</td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_12 . '</td>';
                  echo '</tr>';

                  echo '<tr>';
                       echo '<td>13. Are easily understood </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_13 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 14. LEARNING AIDS (audio-video tapes, computers, maps, pictures, chalk/whiteboard, etc.) </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_14 . '</td>';
                  echo '</tr>';

                  echo '<tr>';
                       echo '<td> 15.Are used effectively</td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_15 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 16. Are of different kinds </td>';
