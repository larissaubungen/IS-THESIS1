   ...
   echo '<input type="text" placeholder="Designation" value="'. $row['E_Position1'] . "/" . $row['E_Position2'] . '" readonly> <br>';
        ...
        echo '<table>';
            ...
            echo '<tbody>';
                  ...
                  echo'<tr>';
                        echo '<td> 1. Has general program that responds to the health needs of the students </td>';
                        echo '<td> &nbsp &nbsp &nbsp'. $ques_1 . '</td>';
                  echo '</tr>';
                  
                  echo '<tr>';
                        echo'<td> 2. Effectively assists students when they go to the clinic </td>';
                        echo '<td> &nbsp &nbsp &nbsp' . $ques_2 . '</td>';
                  echo '</tr>';
                  
                  echo '<tr>';
                       echo '<td> 3. Enjoys the trust and confidence of the students </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_3 . '</td>';
                  echo '</tr>';
                  
                  echo '<tr>';
                       echo '<td> 4. Is approachable and welcoming </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_4 . '</td>';
                  echo '</tr>';

                  echo '<tr>';
                       echo '<td> 5. Attends to all students fairly and equally with no favoritism</td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_5 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td>6.Attends to students with promptness and diligence</td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_6 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 7. Is caring, patient, and understanding to students who are sick </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_7 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 8. as a well-organized system in place </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_8 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 9. Effectively coordinates/facilitates concerns of students, <br> parents and teachers when needed </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_9 . '</td>';
                  echo '</tr>';

                   echo '<tr>';
                       echo '<td> 10. Maintains a clean and orderly clinic </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_10 . '</td>';
                  echo '</tr>';
				  
				  echo '<tr>';
                       echo '<td> 11. Maintains a clean and orderly clinic </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_11 . '</td>';
                  echo '</tr>';
				  
				  echo '<tr>';
                       echo '<td> 12. Has clear rules and regulations and implements these fairly </td>';
