   ...
   echo '<input type="text" placeholder="Designation" value="'. $row['E_Position1'] . "/" . $row['E_Position2'] . '" readonly> <br>';
        ...
        echo '<table>';
            ...
            echo '<tbody>';
                  ...
                  echo'<tr>';
                        echo '<td>  1. Has good posture and is well groomed  </td>';
                        echo '<td> &nbsp &nbsp &nbsp'. $ques_1 . '</td>';
                  echo '</tr>';
                  
                  echo '<tr>';
                        echo'<td> 2. Speaks clearly and correctly </td>';
                  ...
                  echo '<tr>';
                       echo '<td> 5. Knows what he/she teaches </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_5 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td>6. Makes lessons easy to understand </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_6 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 7. Checks that the classroom is clean and orderly </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_7 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 8.Talks about daily life and what is happening in our surroundings  </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_8 . '</td>';
                  echo '</tr>';


                  echo '<tr>';
                       echo '<td> 9. Are interesting and well prepared </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_9 . '</td>';
                  echo '</tr>';

                   echo '<tr>';
                       echo '<td> 10. Are used well </td>';
                       echo '<td> &nbsp &nbsp &nbsp' . $ques_10 . '</td>';
                  echo '</tr>';
                  

                  echo '<tr>';
                       echo '<td>  11. Are of different kinds </td>';
