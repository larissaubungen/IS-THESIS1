...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    ...
    <h4>General Performance Evaluation (GPE 2-B)</h4>
    ...
    <form>
        ...
        <table>
            ...
            <tbody>
                  ...
                  <tr>
                        <td> 5. Building and open, hamonious relationship w/ supervisors </td>
                        <td><input type="radio" name="" value="1"> 1<br></td>
                        <td><input type="radio" name="" value="2"> 2<br></td>
                        <td><input type="radio" name="" value="3"> 3<br></td>
                        <td><input type="radio" name="" value="4"> 4<br></td>    
                  ...
                  <tr>
                        <td> 11. Sensitivity, tact and prudence in dealing with students and paretns </td>
                        <td><input type="radio" name="" value="1"> 1<br></td>
                        <td><input type="radio" name="" value="2"> 2<br></td>
                        <td><input type="radio" name="" value="3"> 3<br></td>
                        <td><input type="radio" name="" value="4"> 4<br></td>    
                  ...
                  <tr>
                        <td> 26. Voluntarism (offering to be of help whenever possible) </td>
                        <td><input type="radio" name="" value="1"> 1<br></td>
                        <td><input type="radio" name="" value="2"> 2<br></td>
                        <td><input type="radio" name="" value="3"> 3<br></td>
                        <td><input type="radio" name="" value="4"> 4<br></td>    
