$(document).ready(function(){
	...
	var IT = [
	    {display: "System Admin", value: "System Admin" }, 
	    {display: "Network Admin", value: "Network Admin" }, 
	    {display: "Computer Technician", value: "Computer Technician" }];
	    
	var Accounting = [
	    {display: "Accountant", value: "Accountant" }, 
	    {display: "Book Keeper", value: "Book Keeper" }, 
	...
	var Others = [
	    {display: "Science Lab Assistant", value: "Science Lab Assistant" }, 
	    {display: "School Nurse", value: "School Nurse" }];

	  //list of the levels corresponding to the academic position
	var preschool = [{display: "Preschool K1", value: "Preschool K1"},
...
$("#department").change(function(){
	...
	var select2 = $("#position option:selected").val();
		...
		case "Chemistry Teacher": 			level(high); break;
			//Humanities Teachers
		case "Reading Teacher": 			level(preschool); break;
		case "Language Teacher": 			level(preschool); break;
